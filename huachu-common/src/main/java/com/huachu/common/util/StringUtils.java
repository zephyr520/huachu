...
public class StringUtils {
    ...
    /**
     * 去掉原串中多余的空格
     * <p>去除头尾空格、换行符、回车符、Tab符替换成一个空格</p>
     * @param original
     * @return
     */
    ...
    public static String getAllFirstLetter(String str) {  
        ...
        String _str = "";  
        for (int i = 0; i < str.length(); i++) {  
            _str = _str + StringUtils.getFirstLetter(str.substring(i, i + 1));  
        }  
    ...
    public static String getFirstLetter(String chinese) {  
        ...
        chinese = StringUtils.conversionStr(chinese, "GB2312", "ISO8859-1");
        ...
        if (chinese.length() > 1) {
            ...
            {  
                chinese = StringUtils.conversionStr(chinese, "ISO8859-1", "GB2312");  
