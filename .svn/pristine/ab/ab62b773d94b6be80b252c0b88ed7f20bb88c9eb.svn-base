...
public final class DesensitizeUtil {
     ...
     * @return
     */
    public static String chineseCompanyName(String fullName) {
     ...
     * @return
     */
    public static String phoneDesensitization(String num) {
        if (StringUtils.isBlank(num)) {
            return "";
        }
        return  num.replaceAll("(\\d{3})\\d{4}(\\d{4})","$1********");
    }
